  ...
  return (
    <div className="absolute w-screen px-8 py-2 bg-gradient-to-b from-black z-10 flex justify-between">
      ...
      {user.user &&(<div className="flex p-2">
        ...
        <button onClick={handleGptClick} className="py-2 px-6 mx-4 mb-5 text-white font-bold bg-purple-800 rounded-lg hover:bg-purple-600">{lang[langId].buttonGpt}</button><img alt="usericon" className="w-12 h-12" src={user.user.photoURL}/>
